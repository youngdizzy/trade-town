...
export class NexusManager {
  ...
  private static foundationalMentorState: FoundationalMentorState = { mentors: [], progress: {}, ceoProgress: {}, activeMentorId: null, roadmapOrder: [], customLessonAnswers: {}, updatedAt: new Date().toISOString() };
