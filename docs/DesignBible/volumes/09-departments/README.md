...
| 61 | [Institutional Knowledge Graph & Company Memory Engine](chapter-61-knowledge-graph-company-memory.md) | Partially implemented — Knowledge Graph extension (backend `app/knowledge_graph.py` + frontend), Pattern Detection Sensitivity CEO controls, and both slices of Knowledge Retention Rules shipped; Quality Score still target design |
