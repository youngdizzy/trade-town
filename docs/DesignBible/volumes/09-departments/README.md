...
| 61 | [Institutional Knowledge Graph & Company Memory Engine](chapter-61-knowledge-graph-company-memory.md) | Partially implemented — Knowledge Graph extension (backend `app/knowledge_graph.py` + frontend) and Pattern Detection Sensitivity CEO controls shipped; Knowledge Retention Rules and Quality Score still target design |
